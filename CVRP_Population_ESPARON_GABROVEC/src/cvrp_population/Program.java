...
public class Program {
	...
	public static void main(String[] args) {
        ...
        String parametersDesc = "Fichier : " + DATA_FILE + " | Nombre de clients : " + (locations.size() - 1) + " | Capacit� maximale des v�hicules : " + MAX_VEHICLES_CAPACITY;
	...
	private static void test(ArrayList<Object[]> parameters) {
		...
		for (Object[] p : parameters) {
	        ...
	        parametersDesc = "Fichier : " + file + " | Nombre de clients : " + (locations.size() - 1) 
	        		+ " | Capacit� maximale des v�hicules : " + MAX_VEHICLES_CAPACITY;
